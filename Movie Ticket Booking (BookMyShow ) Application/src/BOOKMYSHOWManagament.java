...
public class BOOKMYSHOWManagament {
    ...
    private static void bookedHistory() {
        for (BookingDetails movie : MoviesSection.bookedList) {
            if (movie.getUserId() == userList.get(userInd).getUserId()) {
                System.out.println(movie.getBookId() + " --> " +" Today Time --> "+movie.getTodayTime() + " , " + " Show Time --> " + movie.getShowTime() + " , " + "Movie Name --> "+movie.getMovieName() + " , " +
                        "Movie language --> "+movie.getLanguage() + " , " +"Tickes that you bought --> "+movie.getTickets() + " , " + "Total Ticket Cost --> " + movie.getAmount());
            }
        }
        orgUserMenu();
    }
    ...
    private static void showTicket() {
        for (BookingDetails movie : MoviesSection.bookedList) {
            if (movie.getUserId() == userList.get(userInd).getUserId()) {
                System.out.println(movie.getBookId() + "-->" +"Today Time --> "+movie.getTodayTime() + " , " + "Show Time --> " + movie.getShowTime() + " , " + movie.getMovieName() + " , " +
                        movie.getLanguage() + " , " +movie.getTickets() + " , " + "Total Ticket Cost --> " + movie.getAmount());
            }
        }
